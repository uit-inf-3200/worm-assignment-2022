...
The worm must not touch the disk. You can *read* from the disk. In
particular, your worm segment executable will most likely need to read
its own file in order to propagate. But do not write to the disk.
